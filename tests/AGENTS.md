...
- **Keep skill-sync tests target-complete** across OpenCode, Codex, ClaudeCode, AmpCLI, and Agents global/project-local roots, including target markers and per-pack sentinels

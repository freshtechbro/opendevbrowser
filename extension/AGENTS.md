...
- **Help/discovery boundary**: generated help may point users to browser replay, desktop observation, and browser-scoped computer use, but extension guidance must keep the desktop plane external to relay ownership.

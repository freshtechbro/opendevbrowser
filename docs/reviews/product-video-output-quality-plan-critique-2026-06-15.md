...
## Context/Scope
Reviewed `docs/plans/product-video-output-quality-fix-2026-06-15.md` against `prompt-exports/oracle-plan-2026-06-15-203148-product-video-plan-6-c2fe.md`. Spot-checked only the artifact assembly, handoff, and helper seams.

## Findings

### Top 3 under-specified seams
1. **Readiness schema contract.** The plan lists additive fields and statuses but not the exact object shape, required keys, stable reason-code namespace, or criteria rows (`docs/plans/product-video-output-quality-fix-2026-06-15.md:30-47`). The export kept this more concrete with `warnings`, `reasonCodes`, and `criteria` rows (`prompt-exports/oracle-plan-2026-06-15-203148-product-video-plan-6-c2fe.md:247-252`). Without this, `product.json`, `manifest.json`, `meta`, and `presentation-readiness.json` can drift when wired at `src/providers/workflows.ts:6621-6663`.
...
- Dropped useful framing: the final plan lost the export's concrete readiness object shape, concrete live validation command (`prompt-exports/oracle-plan-2026-06-15-203148-product-video-plan-6-c2fe.md:786-801`), and source-field/source-record expectations for candidate rows (`prompt-exports/oracle-plan-2026-06-15-203148-product-video-plan-6-c2fe.md:406-414`).

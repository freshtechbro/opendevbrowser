...
- `package.json` version: `0.0.37`
- `package-lock.json` top-level version and `packages[""]` version: `0.0.37`
- `extension/manifest.json` version: `0.0.37`
- `extension/package.json` version: `0.0.37`

...
cd "$WORKDIR"
npm init -y
npm install <public-repo-root>/opendevbrowser-0.0.32.tgz
...
- `inspiredesign harvest` extends the same workflow with query discovery, ranked references, visual evidence metadata, screenshot PNG artifacts, typed recovery guidance, and a motion-design-aware `meta-prompt.md`.
...
Release gate source of truth: `docs/RELEASE_RUNBOOK.md` and `docs/RELEASE_0.0.32_EVIDENCE.md`.

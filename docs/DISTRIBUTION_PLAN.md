...
As of the 2026-06-05 package metadata audit:
- root package version: `0.0.34`
- root lockfile version and root package entry: `0.0.34`
- extension manifest and extension package version: `0.0.34`
...
- [x] Current public package metadata is aligned at `0.0.34` across root package, root lockfile, extension manifest, and extension package.

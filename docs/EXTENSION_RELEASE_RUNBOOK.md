...
As of the 2026-06-28 release prep, `package.json`, `package-lock.json`, `package-lock.json#packages[""]`, `extension/manifest.json`, and `extension/package.json` are all aligned at `0.0.37`. `extension/manifest.json` is MV3, names the extension `OpenDevBrowser Relay`, and packages the background service worker at `dist/background.js`.
...
4. Confirm the active release evidence ledger, currently `docs/RELEASE_0.0.37_EVIDENCE.md` for package version `0.0.37`, records whether external release workflow evidence is complete or deferred.

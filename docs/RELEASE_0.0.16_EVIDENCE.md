...
- current generated help now leads with browser replay, public desktop observation, and browser-scoped `challengeAutomationMode` capability highlights; that discovery wording is newer than the historical `v0.0.16` snapshot below.

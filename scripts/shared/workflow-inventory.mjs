...
export const VALIDATION_SCENARIOS = [
  ...
  },
  {
    ...
    runner: "cli",
    primaryArgs: ["research", "run", "--topic", "Playwright locator API", "--days", "30", "--source-selection", "web", "--limit-per-source", "1", "--browser-mode", "managed", "--mode", "compact", "--timeout-ms", "120000"],
    secondaryArgs: ["research", "run", "--topic", "Chrome extension debugger API", "--days", "30", "--source-selection", "web", "--limit-per-source", "1", "--browser-mode", "managed", "--mode", "compact", "--timeout-ms", "120000"],
    timeoutMs: 120_000,
    allowedStatuses: ["pass", "env_limited"],

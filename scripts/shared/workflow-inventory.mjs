...
export const VALIDATION_SCENARIOS = [
  ...
  },
  {
    ...
    runner: "cli",
    primaryArgs: ["product-video", "run", "--product-url", "https://www.bestbuy.com/product/logitech-mx-master-3s-bluetooth-edition-performance-wireless-optical-mouse-with-ultra-fast-scrolling-and-quiet-clicks-wireless-black/J7H7ZYG559", "--browser-mode", "managed", "--timeout-ms", "180000", "--include-copy"],
    secondaryArgs: ["product-video", "run", "--product-url", "https://www.bestbuy.com/product/sony-wh-1000xm5-wireless-noise-cancelling-over-the-ear-headphones-black/J7XSRH5CXG", "--browser-mode", "managed", "--timeout-ms", "180000", "--include-copy"],
    timeoutMs: 180_000,
    allowedStatuses: ["pass", "env_limited"],
  ...
  },
  {
    ...
    runner: "cli",
    primaryArgs: ["macro-resolve", "--execute", "--expression", '@media.search(\"browser automation x\", \"x\", 3)', "--timeout-ms", "180000", "--browser-mode", "extension", "--use-cookies", "--cookie-policy", "required", "--challenge-automation-mode", "browser_with_helper"],
    secondaryArgs: ["macro-resolve", "--execute", "--expression", '@media.search(\"browser automation reddit\", \"reddit\", 3)', "--timeout-ms", "180000", "--browser-mode", "extension", "--use-cookies", "--cookie-policy", "required", "--challenge-automation-mode", "browser_with_helper"],
    timeoutMs: 180_000,
    requiresExtension: true,
    allowedStatuses: ["pass", "env_limited"],
    executionPolicy: "automated",

...
export const VALIDATION_SCENARIOS = [
  ...
  },
  {
    ...
    runner: "cli",
    primaryArgs: ["research", "run", "--topic", "Playwright locator API", "--days", "30", "--source-selection", "web", "--limit-per-source", "1", "--browser-mode", "managed", "--challenge-automation-mode", "browser_with_helper", "--mode", "compact", "--timeout-ms", "120000"],
    secondaryArgs: ["research", "run", "--topic", "Chrome extension debugger API", "--days", "30", "--source-selection", "web", "--limit-per-source", "1", "--browser-mode", "managed", "--challenge-automation-mode", "browser_with_helper", "--mode", "compact", "--timeout-ms", "120000"],
    timeoutMs: 120_000,
    allowedStatuses: ["pass", "env_limited"],
    envLimitedDetailMatchers: ["only shell records"],
    executionPolicy: "automated",
    entryPath: "opendevbrowser research run",
    primaryTask: "Research public Playwright locator API guidance with a bounded web-only evidence set.",
    secondaryTask: "Research public Chrome extension debugger API guidance with a bounded web-only evidence set.",
  ...
  },
  {
    ...
    runner: "cli",
    primaryArgs: ["product-video", "run", "--product-url", "https://www.bestbuy.com/site/logitech-mx-master-3s-wireless-laser-mouse-with-ultrafast-scrolling-8k-dpi-any-surface-tracking-and-quiet-clicks-pale-gray/6502574.p?skuId=6502574", "--browser-mode", "managed", "--timeout-ms", "180000", "--include-copy"],
    secondaryArgs: ["product-video", "run", "--product-url", "https://www.bestbuy.com/site/sony-wh-1000xm5-wireless-noise-canceling-over-the-ear-headphones-black/6505727.p?skuId=6505727", "--browser-mode", "managed", "--timeout-ms", "180000", "--include-copy"],
    timeoutMs: 180_000,
    allowedStatuses: ["pass", "env_limited"],
  ...
  },
  {
    ...
    runner: "cli",
    primaryArgs: ["product-video", "run", "--product-name", "Logitech MX Master 3S Wireless Mouse", "--provider-hint", "shopping/bestbuy", "--browser-mode", "managed", "--timeout-ms", "180000", "--include-copy"],
    secondaryArgs: ["product-video", "run", "--product-name", "Sony WH-1000XM5 Headphones", "--provider-hint", "shopping/bestbuy", "--browser-mode", "managed", "--timeout-ms", "180000", "--include-copy"],
    timeoutMs: 180_000,
    allowedStatuses: ["pass", "env_limited"],
    envLimitedDetailMatchers: PRODUCT_VIDEO_ENV_LIMITED_DETAIL_MATCHERS,
    executionPolicy: "automated",
  ...
  },
  {
    ...
    runner: "cli",
    primaryArgs: ["macro-resolve", "--execute", "--expression", '@web.search(\"site:developer.mozilla.org playwright locator\", 4)', "--timeout-ms", "120000", "--browser-mode", "managed", "--challenge-automation-mode", "browser_with_helper"],
    secondaryArgs: ["macro-resolve", "--execute", "--expression", '@web.search(\"site:developer.chrome.com devtools protocol popup attach\", 4)', "--timeout-ms", "120000", "--browser-mode", "managed", "--challenge-automation-mode", "browser_with_helper"],
    timeoutMs: 120_000,
    allowedStatuses: ["pass", "env_limited"],
    executionPolicy: "automated",
  ...
  },
  {
    ...
    runner: "cli",
    primaryArgs: ["macro-resolve", "--execute", "--expression", '@community.search(\"browser automation failures\", 4)', "--timeout-ms", "120000", "--browser-mode", "extension", "--use-cookies", "--cookie-policy", "required", "--challenge-automation-mode", "browser_with_helper"],
    secondaryArgs: ["macro-resolve", "--execute", "--expression", '@community.search(\"popup attach failures\", 4)', "--timeout-ms", "120000", "--browser-mode", "extension", "--use-cookies", "--cookie-policy", "required", "--challenge-automation-mode", "browser_with_helper"],
    timeoutMs: 120_000,
    allowedStatuses: ["pass", "env_limited"],
    executionPolicy: "automated",
  ...
  },
  {
    ...
    runner: "cli",
    primaryArgs: ["macro-resolve", "--execute", "--expression", '@media.search(\"browser automation x\", \"x\", 5)', "--timeout-ms", "120000", "--browser-mode", "extension", "--use-cookies", "--cookie-policy", "required", "--challenge-automation-mode", "browser_with_helper"],
    secondaryArgs: ["macro-resolve", "--execute", "--expression", '@media.search(\"browser automation reddit\", \"reddit\", 5)', "--timeout-ms", "120000", "--browser-mode", "extension", "--use-cookies", "--cookie-policy", "required", "--challenge-automation-mode", "browser_with_helper"],
    timeoutMs: 120_000,
    allowedStatuses: ["pass", "env_limited"],
    executionPolicy: "automated",

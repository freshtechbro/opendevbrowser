...
export const PUBLIC_SURFACE_MANIFEST_GENERATED_AT = "2026-06-30T07:04:16.063Z" as const;

export const PUBLIC_SURFACE_MANIFEST = {
  "schemaVersion": "2026-04-04",
  "generatedAt": "2026-06-30T07:04:16.063Z",
  "cli": {
    "groups": [
      {
    ...
    "commands": [
      ...
      },
      {
        ...
        "notes": [
          ...
          "Use --google-auth-intent user-owned only when the run must reuse a user-owned Google OAuth session. It requires extension /ops against the live Chrome profile and fails closed for --no-extension, --headless, --extension-legacy, and direct CDP.",
      ...
      },
      {
        ...
        "groupSummary": "Execute typed /canvas commands for session, workspace, document, preview, and code-sync flows."
      },
      {
        "name": "goto",
      ...
      },
      {
        ...
        "examples": [
          "npx opendevbrowser screenshot --session-id s1 --output-format json",
      ...
      },
      {
        ...
        "examples": [
          "npx opendevbrowser screencast-start --session-id s1 --interval-ms 750 --max-frames 40 --output-format json",
    ...
    "flags": [
      ...
      {
        "name": "--google-auth-intent",
        "kind": "value"
      },
      {
        "name": "--disable-system-cookie-bootstrap",
        "kind": "boolean"
      },
      {
        "name": "--allow-google-cookie-bootstrap",
        "kind": "boolean"
      },
      {
        "name": "--skills-global",
    ...
    "entries": [
      {
        ...
        "example": "{\"googleAuthIntent\":\"user_owned_google\",\"disableSystemCookieBootstrap\":true,\"allowGoogleCookieBootstrap\":false,\"extensionOnly\":true,\"waitForExtension\":true}",
        "notes": [
          "Use --google-auth-intent user-owned only when the run must reuse a user-owned Google OAuth session. It requires extension /ops against the live Chrome profile and fails closed for --no-extension, --headless, --extension-legacy, and direct CDP.",
          "Managed and direct cdpConnect use best-effort readable system Chrome-family cookie bootstrap, but copied cookies are not Google auth proof. Google-sensitive cookies are skipped by default; use --allow-google-cookie-bootstrap only when you explicitly accept the diagnostic risk. Use --disable-system-cookie-bootstrap to skip all bootstrap for a run. Results expose sanitized diagnostics.authProvenance without private cookies, tokens, account identifiers, full profile paths, or account screenshots.",
          "After Google sign-in or account chooser actions, recover the active OAuth popup with targets-list --include-urls, then target-use --target-id <target-id>."
      ...
      },
      {
        ...
        "example": "{\"wsEndpoint\":\"ws://127.0.0.1:8787/ops\",\"googleAuthIntent\":\"user_owned_google\",\"disableSystemCookieBootstrap\":true,\"allowGoogleCookieBootstrap\":false}",
        "notes": [
          "Use --google-auth-intent user-owned only when the run must reuse a user-owned Google OAuth session. It requires extension /ops against the live Chrome profile and fails closed for --no-extension, --headless, --extension-legacy, and direct CDP.",
          "Managed and direct cdpConnect use best-effort readable system Chrome-family cookie bootstrap, but copied cookies are not Google auth proof. Google-sensitive cookies are skipped by default; use --allow-google-cookie-bootstrap only when you explicitly accept the diagnostic risk. Use --disable-system-cookie-bootstrap to skip all bootstrap for a run. Results expose sanitized diagnostics.authProvenance without private cookies, tokens, account identifiers, full profile paths, or account screenshots.",
          "After Google sign-in or account chooser actions, recover the active OAuth popup with targets-list --include-urls, then target-use --target-id <target-id>."
      ...
      },
      {
        ...
        "description": "Run the inspiredesign workflow directly, including provider-scoped URL recovery, harvest query discovery, screenshot and screencast evidence for non-Pinterest capture lanes, and required manifest-backed pin-media authority for canonical Pinterest pins.",
      ...
      },
      {
        ...
        "description": "Execute a typed design-canvas command surface call, including refs-only workspace orchestration over child sessions.",
      ...
      },
      {
        ...
        "description": "Capture a page screenshot and persist omitted outputs under .opendevbrowser/screenshot/<uuid>/capture.png.",
        "cliEquivalent": "screenshot",
        "example": "npx opendevbrowser screenshot --session-id s1 --output-format json"
      },
      {
        "name": "opendevbrowser_screencast_start",
        "description": "Start a browser replay screencast capture and persist omitted outputs under .opendevbrowser/screencast/<uuid>.",
        "cliEquivalent": "screencast-start",
        "example": "npx opendevbrowser screencast-start --session-id s1 --interval-ms 750 --max-frames 40 --output-format json"
      },
      {

  ...
  "tools": {
    "entries": [
      ...
      },
      {
        ...
        "description": "Run the inspiredesign workflow directly, including provider-scoped URL recovery, harvest query discovery, screenshot evidence, screencast evidence, and manifest-backed pin-media evidence for canonical Pinterest pins.",
